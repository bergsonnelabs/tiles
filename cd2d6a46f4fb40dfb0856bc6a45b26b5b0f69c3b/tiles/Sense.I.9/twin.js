...
var ACCEL_LSB_PER_G = { 0: 16384, 2: 8192, 4: 4096, 6: 2048 };
var GYRO_LSB_PER_DPS = { 0: 131, 2: 65.5, 4: 32.8, 6: 16.4 };
var MAG_UT_PER_LSB = 0.15;
var MAG_MAX = 32752;
var MAG_HZ = { 2: 10, 4: 20, 6: 50, 8: 100 };
...
var sim = {
  ...
  hostCalls: {
    ...
    tile_sense_i_9_set_mag_mode: ({ args }) => ({ nextState: { mag_mode: (args[0] ?? 0) & 31 } }),
    ...
    tile_sense_i_9_int_config: ({ state, args }) => ({
      nextState: { int_pin_cfg: (args[0] ?? 0) & 240 | state.int_pin_cfg & BYPASS_EN }
    }),
    ...
    tile_sense_i_9_fifo_count: ({ state }) => ({ scalar: state.fifo_bytes & 8191 }),
    ...
    tile_sense_i_9_read_tilt_centi_degrees: () => void 0,
    tile_sense_i_9_read_heading_centi_degrees: () => void 0,
    // ── DMP ──
  ...
  provenance: {
    ...
    tile_sense_i_9_read_tilt_centi_degrees: "inferred",
